...
// fix parser common
class_alias('Composer\ClassMapGenerator\ClassMapGenerator', 'Composer\Autoload\ClassMapGenerator');
 ...
 * Class EmailProcess
 */
class EmailProcess extends Job
{
    /**
...
//        }
    ...
    protected function exception()
    {
        ...
        print_r(['AbuseIO was not able to process an incoming message. This message is attached to this email.',
                [
